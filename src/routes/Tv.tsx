...
import { getImageUrl, getTv, type IMovie, type IMovieData } from "../api"
...
{isLoading1 || isLoading2 || isLoading3 || isLoading4 ?
    ...
    <Title>
        <span className="title">{now_playing?.results[0].name}</span>
    ...
    >
        <DetailImg style={{ 
            ...
            <DetailTitle>{info.name}</DetailTitle>
        </DetailImg>
    ...
    <SliderBox>
        {now_playing ? <Slider data={now_playing} root="tv" type="now_playing"/>: null }
        {upcoming ? <Slider data={upcoming} root="tv" type="upcoming"/>: null}
        {top_rated ? <Slider data={top_rated} root="tv" type="top_rated"/>: null}
        {popular ? <Slider data={popular} root="tv" type="popular"/>: null}
    </SliderBox>
    </>
}
</Boxes>
